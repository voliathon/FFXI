function user_setup()
    ...
    gear.pet_atk_back={ name="Artio's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Pet: Attack+1 Pet: Rng.Atk.+1',}},
...
function init_gear_sets()
	...
	sets.midcast.Pet.WS = {
        ...
        legs=gear.valorous_pet_legs,
        --feet={ name="Taeon Boots", augments={'Pet: Accuracy+12 Pet: Rng. Acc.+12','Pet: "Dbl. Atk."+3',}},
	...
	sets.midcast.Pet.MagicReady = {main=gear.MABKumbha,sub=gear.PDTMABKumbha,ammo="Demonry Core",
		...
		back=gear.pet_atk_back,waist="Incarnation Sash",legs=gear.valorous_magical_pet_legs,feet=gear.valorous_magical_pet_feet}
