...
--					  1		   2              3 				   4 		    5		     6
  ...
  sets.Resolution = {
    ammo="Aurgelmir Orb",
    head={ name="Valorous Mask", augments={'Mag. Acc.+17','Pet: DEX+3','Weapon skill damage +8%','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
    body="Sakpata's Plate",
    hands={ name="Valorous Mitts", augments={'"Fast Cast"+2','Rng.Atk.+2','Weapon skill damage +8%','Accuracy+2 Attack+2',}},
